...
[Public CVE case studies](https://github.com/foxirain/CVE-public) · [Linux mainline contributions](#linux-mainline-contributions) · [Email](mailto:hataegu0826@gmail.com)
...
| [**Security Research QA Harness**](https://github.com/foxirain/security-research-qa-harness) | Independent replay, positive and negative controls, boundary variants, and runtime-evidence comparison | 30/30 public regression checks · reproducible case contract |

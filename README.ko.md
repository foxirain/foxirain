...
[공개 CVE 사례](https://github.com/foxirain/CVE-public) · [Linux mainline 기여](#linux-mainline-기여) · [이메일](mailto:hataegu0826@gmail.com)
...
| [**Security Research QA Harness**](https://github.com/foxirain/security-research-qa-harness) | 독립 재현, positive·negative control, boundary variant와 runtime evidence 비교 | 공개 regression 30/30 · 재현 가능한 case contract |
